/*
 * logInteriorPoint_conjgrad_rt_mu.c
 *
...
static emlrtRSInfo emlrtRSI = { 12,    /* lineNo */
  "logInteriorPoint_conjgrad_rt_mu",   /* fcnName */
  "/home/jordanleung/Documents/GitHub/optimizationFunctions/logInteriorPoint_conjgrad_rt_mu.m"/* pathName */
};
...
static void b_solveNewtonStep(e_logInteriorPoint_conjgrad_rt_ *SD, const
  emlrtStack *sp, const real_T v[120], const real_T const_invW[14400], const
  real_T const_c[120], const real_T const_A[14400], const real_T const_b[120],
  real_T const_maxCGIter, const real_T const_GDiag[120], const real_T d0[120],
...
static void solveNewtonStep(e_logInteriorPoint_conjgrad_rt_ *SD, const
  emlrtStack *sp, const real_T v[120], const real_T const_invW[14400], const
  real_T const_c[120], const real_T const_A[14400], const real_T const_b[120],
  real_T const_maxCGIter, const real_T const_GDiag[120], real_T preCondFlag,
  real_T d[120], real_T dNext[120], real_T fNext[120], real_T MTilde[120],
  real_T *numIter, real_T *resStar, real_T *applyPreCond);
static real_T solveNewtonStep_warmStart(const emlrtStack *sp, const real_T b[120],
  const real_T v[120], const real_T const_invW[14400], const real_T const_A
  [14400], real_T const_maxCGIter, real_T d0[120], const real_T MTilde[120],
  real_T applyPreCond);
  ...
  real_T MTilde[120], real_T *numIter, real_T *resStar, real_T *applyPreCond)
{
  ...
  *numIter = 1.0;
  ...
  /*  Iterate...  */
  /*  bNorm = norm(b,2); */
  while ((*numIter <= const_maxCGIter) && (res > 1.0E-10)) {
  ...
  *mu, real_T *execTime, real_T *numIter, real_T *totalCGIters)
{
  ...
  *numIter = 0.0;
  ...
  st.site = &d_emlrtRSI;
  solveNewtonStep(SD, &st, v0, SD->f2.invW, c, Aineq, bineq, maxCGIter, GDiag,
                  preCondFlag, xStar, D, zPrev, b, &CGIters, &alpha,
                  &appliedPreCond);

  /*  Run seconds Newton system starting at warm-start d2Hat */
  st.site = &e_emlrtRSI;
  alpha = solveNewtonStep_warmStart(&st, zPrev, v0, SD->f2.invW, Aineq,
    maxCGIter, D, b, appliedPreCond);
  *totalCGIters = CGIters + alpha;
  ...
  if (startFlag < 1) {
    ...
    while ((!exitg1) && ((c_norm(d) > 1.0) || (startFlag == 1))) {
      ...
      if (*numIter >= maxIter) {
        ...
        /*  Iterate...  */
        /*  bNorm = norm(b,2); */
        while ((CGIters <= maxCGIter) && (alpha > 1.0E-10)) {
          memcpy(&zPrev[0], &z[0], 120U * sizeof(real_T));
          if (applyPreCond != 0) {
            for (k = 0; k < 120; k++) {
              z[k] = r[k] / unusedU3[k];
  ...
  while (((*mu > mu_f) || (alpha > 1.0)) && (*numIter < maxIter)) {
    ...
    st.site = &j_emlrtRSI;
    b_solveNewtonStep(SD, &st, v, SD->f2.invW, c, Aineq, bineq, maxCGIter, GDiag,
                      xStar, preCondFlag, d1, D, zPrev, b, &CGIters, &alpha,
                      &appliedPreCond);
    ...
    *totalCGIters += CGIters;
    ...
    /*  Run the second */
    st.site = &k_emlrtRSI;
    CGIters = solveNewtonStep_warmStart(&st, zPrev, v, SD->f2.invW, Aineq,
      maxCGIter, D, b, appliedPreCond);
    *totalCGIters += CGIters;
...
/* End of code generation (logInteriorPoint_conjgrad_rt_mu.c) */
