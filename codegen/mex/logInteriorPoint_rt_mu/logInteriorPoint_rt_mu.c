...
/* Include files */
#include "logInteriorPoint_rt_mu.h"
#include "chol.h"
#include "inv.h"
...
static emlrtRSInfo emlrtRSI = { 13,    /* lineNo */
  "logInteriorPoint_rt_mu",            /* fcnName */
  "/home/jordanleung/Documents/GitHub/optimizationFunctions/logInteriorPoint_rt_mu.m"/* pathName */
};
...
static void solveNewtonStep(logInteriorPoint_rt_muStackData *SD, const
  emlrtStack *sp, real_T mu, const real_T v[120], const real_T const_W[14400],
  const real_T const_c[120], const real_T const_A[14400], const real_T const_b
  [120], real_T x[120]);
static void solveNewtonStep_decomp(logInteriorPoint_rt_muStackData *SD, const
...
void logInteriorPoint_rt_mu(logInteriorPoint_rt_muStackData *SD, const
  emlrtStack *sp, const real_T W[14400], const real_T c[120], real_T A[14400],
  const real_T bineq[120], real_T mu_f, real_T mu_0, const real_T v0[120],
  real_T maxIter, real_T x[120], real_T *mu, real_T *execTime, real_T *numIter)
{
  emlrtStack b_st;
  emlrtStack st;
  real_T Qvec[120];
...
/* End of code generation (logInteriorPoint_rt_mu.c) */
