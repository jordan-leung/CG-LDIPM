/*
 * _coder_logInteriorPoint_rt_mu_api.c
 *
 * Code generation for function '_coder_logInteriorPoint_rt_mu_api'
 *
 */
...
#include "logInteriorPoint_rt_mu_mexutil.h"
...
void logInteriorPoint_rt_mu_api(logInteriorPoint_rt_muStackData *SD, const
  mxArray * const prhs[8], int32_T nlhs, const mxArray *plhs[4])
{
  ...
  A = c_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_2), "A");
  ...
  logInteriorPoint_rt_mu(SD, &st, *W, *c, *A, *bineq, mu_f, mu_0, *v0, maxIter, *
    x, &mu, &execTime, &numIter);
...
/* End of code generation (_coder_logInteriorPoint_rt_mu_api.c) */
