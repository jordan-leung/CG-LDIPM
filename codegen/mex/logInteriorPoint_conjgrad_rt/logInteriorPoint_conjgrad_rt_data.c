/*
 * logInteriorPoint_conjgrad_rt_data.c
 *
 * Code generation for function 'logInteriorPoint_conjgrad_rt_data'
 *
 */
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "logInteriorPoint_conjgrad_rt",      /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
/* End of code generation (logInteriorPoint_conjgrad_rt_data.c) */
