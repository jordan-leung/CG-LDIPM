...
mu2 = mu;
k2 = 1/sqrt(mu2);
[x2,d2Hat,r2,cg2,rlim2,xFeas] = solveNewtonStep(mu2,v,const,maxCGIter,CGTol,x,xFeas);

% Sample point 2
mu1 = 100*mu2;
k1 = 1/sqrt(mu1);
[x1,d1Hat,r1,cg1,rlim1,xFeas1] = solveNewtonStep(mu1,v,const,maxCGIter,CGTol,x,xFeas);
...
while mu > mu_f || norm(d,'inf') > 1
    ...
    mu2 = mu;
    k2 = 1/sqrt(mu2);
    [x2,d2Hat,r2,cg2,rlim2,xFeas2] = solveNewtonStep(mu2,v,const,maxCGIter,CGTol,x,xFeas);
...
if min(lambda) > -1e-4
    ...
    [x,d,r,cg] = solveNewtonStep(mu,v,const,maxCGIter,CGTol,x,x,1);
    alpha = min(1, 1/(norm(d,'inf')^2));
    v = v + alpha*d;
...
function [x,d,r,numIter,resLim,xFeas] = solveNewtonStep(mu,v,const,maxIter,tol,x0,xFeas,exactFlag)
if nargin < 8
    exactFlag = 0;
end
