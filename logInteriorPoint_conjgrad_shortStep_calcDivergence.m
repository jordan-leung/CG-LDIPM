function [x,v,mu,execTime,numIter,CGIters,CGres,dHist,divHist,decreaseIters,fPrimeHist,fPrimeInitHist] = logInteriorPoint_conjgrad_calcDivergence(W,c,Aineq,bineq,mu_f,mu_0,v0,maxIter,maxCGIter,CGTol,preCondFlag,params,vThresh,vNumThresh)
...
while mu > mu_f
    ...
    for j = 1:N_ls
        ...
        divHist(numIter) = h_i;
        fPrimeHist(numIter) = fPrime_i;
        fPrimeInitHist(numIter) = fPrimeInit_i; 
    end
end
execTime = toc;
...
fPrimeHist = fPrimeHist(1:numIter);
fPrimeInitHist = fPrimeInitHist(1:numIter);
