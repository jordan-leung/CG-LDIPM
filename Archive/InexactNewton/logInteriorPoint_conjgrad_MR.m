function [x,lambda,s,v,mu,startFlag,numIter,muStar,exitFlag,execTime,CGIters,CGres] = logInteriorPoint_conjgrad_MR(W,c,A,b,mu_f,mu_0,v0,maxIter,maxCGIter,CGTol,printFlag)
...
% Outer-loop condition monitors the Algorithm MR inexact Newton condition
d = x + d0;
