...
mu2 = mu;
k2 = 1/sqrt(mu2);
[x2Hat,d2Hat,cg2] = solveNewtonStep(mu2,v,const,maxCGIter,CGTol,x);
...
while mu > mu_f || norm(d,'inf') > 1
    ...
    mu1 = 100*mu;
    k1 = 1/sqrt(mu1);
    [x1,d1Hat,cg1] = solveNewtonStep(mu1,v,const,maxCGIter,CGTol,x);
    
    % Sample point 2
    mu2 = mu;
    k2 = 1/sqrt(mu2);
    [x2,d2Hat,cg2] = solveNewtonStep(mu2,v,const,maxCGIter,CGTol,x);
